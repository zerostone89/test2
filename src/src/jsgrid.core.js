(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        _createNoDataRow: function() {
			...
			if (items.length == 0)
			{
				$('#btn_all_cancel').attr('disabled', true);
				$('#btn_cancel').attr('disabled', true);
				$('#btn_all_dc').attr('disabled', true);
        ...
        _createRow: function(item, itemIndex) {
			...
			if (items.length != 0)
			{
				$('#btn_all_cancel').attr('disabled', false);
				$('#btn_cancel').attr('disabled', false);
				$('#btn_all_dc').attr('disabled', false);
        ...
        _createCell: function(item, field) {
            ...
            if($.isFunction(field.cellRenderer)) {
               ...
               if (parseInt(fieldValue)<0)
				{
					$result = $("<td>").css('color','red').append(this.renderTemplate(field.itemTemplate || fieldValue, field, args));
				}
				else
				{
