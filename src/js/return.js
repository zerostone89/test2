...
function return_search(chk_gb) {
	...
	console.log(date_from +":"+date_to+":"+gubun+":"+return_tag+":"+search_barcode+":"+confirm_from+":"+confirm_to);
	//191014  modified by jsys
	$('#btn-spcchk-save').attr('disabled', true);
	$('#btn-return-del').attr('disabled', true);
	$('#btn-add').attr('disabled', true);
  ...
  $('#modi_label1').text("");
              ...
              j = i + 1;
                  ...
                  + "<td style='display:none;'>" +jObject.data[i].SIL_OUTNO+  "</td>"
							...
							t_data1 += "<tr><td align='center' width='30'></td>"
									...
									+ "<td align='center' width='60' style = 'fontWeight:bold;'>" + jObject.T_REQQTY + "</td>"
									+ "<td align='center' width='60  style = 'fontWeight:bold;'>" + jObject.T_CFQTY + "</td>"
									+ "<td align='center' width='60' style='color:"+fontcolor+";'>"+F_QTY+"</td>"
	...
	{//º»»ç¹ÝÇ°
				$('#table_area_top').find('tbody').empty();
				var top_data ="";
				top_data += "<tr bgcolor='#1BA892'><td align='center'height='26'  width='25'>&nbsp;</td>"
										+ "<td align='center'height='26'  width='150'>ÀÇ·ÚÀÏÀÚ</td>"
										+ "<td align='center' width='150'>Ã¢°í</td>"
										+ "<td align='center' width='200'>ÀüÇ¥¹øÈ£</td>"
										+ "<td align='center' width='100'>È®Á¤¼ö·®</td>"
										+ "<td align='center' width='250'>ºñ°í</td>"
										+ "</tr>";

				$('#table_area_top').find('tbody').append(top_data);
				var promise = $.ajax({
					url: "./return_search_bonsa.asp",
					type: "POST",
					data: {
							"day1"		: date_from,
							"day2"	: date_to
					...
					try {
						...
						if (jObject.error === "1") {
						   ...
						   searching_close();
							...
							for(var i = 0; i < jObject.data.length; i++) {
								var outdt = jObject.data[i].OUTDT;
								t_data += "<tr ><td align='center'height='26'  width='25'><input id='" + i + "' type='checkbox' name='radiogroup'><input type='hidden' id ='area_ordt"+i+"' value='"+outdt+"' ></td>"
										+ "<td align='center' width='150'> " + outdt.substring(0,4)+"-"+outdt.substring(4,6) +"-"+outdt.substring(6,8) + "</td>"
										+ "<td align='center' width='150'>" + jObject.data[i].WHNM + "</td>"
										+ "<td align='center' width='200'><input type='hidden' id ='area_orno"+i+"' value='"+ jObject.data[i].OUTNO + "' >" + jObject.data[i].OUTNO + "</td>"
										+ "<td align='center' width='100'>" + jObject.data[i].OUTQTY + "</td>"
										+ "<td align='center' width='250'>" + jObject.data[i].REMARK + "</td></tr>";
							}
							$('#table_area').find('tbody').append(t_data);

							t_data1 += "<tr ><td align='center'height='26'  width='25'></td>"
										+ "<td align='center' width='150'></td>"
										+ "<td align='center' width='150'></td>"
										+ "<td align='center' width='200'>ÃÑ°è</td>"
										+ "<td align='center' width='100'>" + jObject.T_OUTQTY + "</td>"
...
if (gubun == 2 )//¸ÅÀå¹ÝÇ°°Ë»ö
			{
                ...
                fontWeight = "bold";
								...
								t_data1 += "<tr><td align='center' width='30'></td><td align='center'width='30'></td>"
			...
			else if (gubun == 3)//º»»çÈ®Á¤°Ë»ö
			{
					$('#btn-return-box').attr('disabled',true);
					$('#table_area1_top').find('tbody').empty();
						var top_data ="";
						var top_data1 ="";
						top_data += "<tr  bgcolor='#b5e6ff'><td align='center'height='26'  width='30'>¹øÈ£</td>"
												+ "<td align='center' width='70'>Ã¢°í</td>"
												+ "<td align='center' width='50'>ÆÇ¸ÅÀ¯Çü</td>"
												+ "<td align='center' width='70'>½ºÅ¸ÀÏ</td>"
												+ "<td align='center' width='70'>Ä®¶ó</td>"
												+ "<td align='center' width='70'>»çÀÌÁî</td>"
												+ "<td align='center' width='70'>È®Á¤¼ö·®</td>"
												+ "<td align='center' width='70'>ÆÇ¸Å´Ü°¡</td>"
												+ "<td align='center' width='70'>°ø±Þ´Ü°¡</td>"
												+ "<td align='center' width='70'>ÆÇ¸Å°¡¾×</td>"
												+ "<td align='center' width='70'>ºñ°í</td>"
												+ "</tr>";
						...
						try {
							...
							if (jObject.error === "1") {
							   ...
							   searching_close();
								...
								var OUTAMT = parseInt(jObject.data[i].OUTQTY  * jObject.data[i].OUTPRI );
									t_data += "<tr><td align='center'bgcolor='white' width='30'>"+ jObject.data[i].SEQ + "</td>"
											+ "<td align='center' bgcolor='white' width='70'>" + jObject.data[i].WHNM + "</td>"
											+ "<td align='center'bgcolor='white' width='50'>" + jObject.data[i].REFSNM + "</td>"
											+ "<td align='center'bgcolor='white' width='70'>" + jObject.data[i].STYCD + "</td>"
											+ "<td align='center'bgcolor='white' width='70'>" + jObject.data[i].COLCD + "</td>"
											+ "<td align='center'bgcolor='white' width='70'>" + jObject.data[i].SIZECD + "</td>"
											+ "<td align='center'bgcolor='white' width='70'>" + jObject.data[i].OUTQTY + "</td>"
											+ "<td align='right'bgcolor='white' width='70'>" + numberWithCommas(jObject.data[i].OUTPRI) + "</td>"
											+ "<td align='right'bgcolor='white' width='70'>" + numberWithCommas(jObject.data[i].SUPPRI) + "</td>"
											+ "<td align='right'bgcolor='white' width='70'>" + numberWithCommas(OUTAMT) + "</td>"
											+ "<td align='center'bgcolor='white' width='70'>" + jObject.data[i].REMARK + "</td>"
											+ "</tr>";
								}

									t_data1 += "<tr><td align='center'bgcolor='white' width='30'></td>"
											+ "<td align='center' bgcolor='white' width='70'></td>"
											+ "<td align='center'bgcolor='white' width='50'></td>"
											+ "<td align='center'bgcolor='white' width='70'></td>"
											+ "<td align='center'bgcolor='white' width='70'></td>"
											+ "<td align='center'bgcolor='white' width='70'></td>"
											+ "<td align='center'bgcolor='white' width='70'>" + jObject.T_OUTQTY + "</td>"
											+ "<td align='right'bgcolor='white' width='70'></td>"
											+ "<td align='right'bgcolor='white' width='70'></td>"
											+ "<td align='right'bgcolor='white' width='70'></td>"
											+ "<td align='center'bgcolor='white' width='70'></td>"
											+ "</tr>";
  ...
  var cfqty = $("#modi_CFQTY").val();
	var promise = $.ajax({
        ...
        $('#list_totqty1').text(cfqty);
				...
				console.log(jObject.data1[0].INUSER);
