  ...
  var gubun = $('#gubun').val();
        ...
        try {
            ...
            $('#table_area_top').find('tbody').empty();
                                    ...
                                    + "<td width='50' align='center' >±¸ºÐ</td>"
            												+ "<td width='80' align='center' >ÀÔ°íÀÏÀÚ</td>"
            												+ "<td width='100' align='center' >ÀüÇ¥¹øÈ£</td>"
            												+ "<td width='100' align='center' >¹Ú½º¹øÈ£</td>"
            												+ "<td width='80' align='center' >¼ö·®</td>"
            												+ "</tr>";
                      ...
                      t_data1 += "<tr><td align='center' width='30'></td>"
									...
									+ "<td align='center' style='font-Weight : bold;' width='70'>ÃÑ°è</td>"
		...
		if (chk > 0)
		{
           ...
           $('input[name*="radiogroup"]').prop('checked', false);
			...
			//Çà Å¬¸¯½Ã »ö»ó º¯°æ
				...
				//Çà Å¬¸¯½Ã »ö»ó º¯°æ end  20190925 ÇÏ´ÜµðÅ×ÀÏÁ¶È¸
			if (document.getElementById('jun_radio').checked)//ÀüÇ¥ Á¶È¸¸é
			{
        var outdt = td.eq(2).text();
				var outno = td.eq(3).text();
			}else if (document.getElementById('box_radio').checked) // ¹Ú½º Á¶È¸¸é
			{
        var outdt = td.eq(2).text();
				var outno = td.eq(3).text();
			}
...
function detail_search(productList){//¹ÝÇ°µðÅ×ÀÏÁ¶È¸ 20191106 ÇÏ´ÜµðÅ×ÀÏÁ¶È¸ Æã¼Ç
	var itemsStr = JSON.stringify(productList);
            ...
            console.log(itemsStr);
						top_data += "<tr  bgcolor='#1BA892'>"
												...
												+ "<td align='center' width='80'>½ºÅ¸ÀÏ</td>"
												+ "<td align='center' width='40'>Ä®¶ó</td>"
												+ "<td align='center' width='50'>»çÀÌÁî</td>"
												+ "<td align='center' width='70'>Ãâ°íÀ¯Çü</td>"
												+ "<td align='center' width='80'>ÆÇ¸Å°¡</td>"
                        + "<td align='center' width='40'>¼ö·®</td>"
                        + "<td align='center' width='80'>±Ý¾×</td>"
												+ "</tr>";
					...
					promise.done(function(data) {
						...
						try {
							...
							if (jObject.error === "1") {
							   ...
							   alert(jObject.msg);
                 console.log("¼¼ºÎÁ¶È¸ ½ÇÆÐ: "+jObject.sql1);
							   searching_close();
							} else if (jObject.error === "0") {
              //
								console.log("¼¼ºÎ Á¶È¸ ¼º°ø");
							 	var t_data = "";
							 	var t_data1 = "";
								for(var i = 0; i < jObject.data.length; i++) {
								var tag  = jObject.data[i].OUTYN;
                ...
                + "<td align='center'  width='70'>ÇÕ°è</td>"
