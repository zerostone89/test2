<meta name="generator" content="Namo WebEditor(Trial)">
				...
				<!--20190419-->
			  <style>
			  #layer_popup { width:500px; height:566px; left:30%; position:relative; background-color: #fff; border:1px solid gray;}
			  .close div{float:left; text-align:right;}
			  #check{font-size:12px; font-family:'돋움'; margin : 4px 0px 4px 0px;}
			  #close{font-size:12px; font-family:'돋움'; margin : 11px 0px 0px 30px;}
			  #close a { color:black; }
			...
			<div id="layer_popup" style="visibility: invisible; position:absolute; background-color:#fff">
				<div class="close">
			     	...
			     	<p><img src="/sms_caution.png" width="500px" height="566px" border="0" alt="sms_caution.png"></p>
