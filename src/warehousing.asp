...
<div class="main-body">
  ...
  <!-- 20191016 byCho 레이아웃수정 -->
  <div class="main-top">
        <table width="100%" height="10%" >
          <tr width="100%" height="100%" cellspacing="0">
              <td width="35%"></td>
              <td width="30%" style=" font-weight: bold;text-align: center;font-size: 14pt;">물류입고조회[<%=dpcd%>]</td>
  ...
  <div class="main-middle1">
	...
	<tr>
		<td width="90%" align="center">
			...
			<tr bgcolor="#1BA892" height="30">
				<td width="12%" align="center" height="26">입고일자</td>
				...
				<td  width="12%" align="center">
								<label style="width: 100%; height: 100%;" style="font-weight:bold;">구분</label>
        </td>
        <td  width="15%" align="center" bgcolor="#FFFFFF">
          <select id ='gubun' >
            		<OPTION value="%">전체</OPTION>
                <OPTION value="S1000">물류(정상)</OPTION>
                <OPTION value="S4000">정상(고객만족)</OPTION>
            </select>
        </td>
        <td  width="8%" align="center" >
								<label style="width: 100%; height: 100%;" style="font-weight:bold;">브랜드</label>
        </td>
        <td  width="13%" align="center" bgcolor="#FFFFFF">
			...
			<tr bgcolor="#1BA892" height="40">
			  ...
			  <td align="center" height="26">전표&박스번호</td>
            ...
            <label  style="cursor:pointer; font-size:10px;" for="jun_radio">전표</label>
            <input name="radio"  style="width:10px;height:10px;" id="box_radio" type="radio" value="2" >
            <label  style="cursor:pointer; font-size:10px;" for="box_radio">박스</label>&nbsp;
        ...
        <td align="center" height="26" width="70" colspan="2">품번</td>
        ...
        <td bgcolor="#FFFFFF"  align="center"  colspan="3">
          <input  type="button" class="btn_basic" onclick="return_search();" value="검색"style="width:90%; height:100%;vertical-align: middle;">
        </td>
			</tr>
	...
	<div class="bottom-btn">
		<table width="90%" >
			...
			<tr>
					<td width="20%">
            <input type="button" id="btn-return-box" class="btn_basic1" onclick="boxlist_open();" value="입고내역서">
					</td>
			...
			<div class="div-body">
				...
				<tr>
					<td width="15%">
						...
						<input type="button" class="btn_basic1" onclick="boxlist_open();" value="박스내역서">
					</td>
        ...
        <table width="100%">
          <tr>
            ...
            <td width="70%" align = "center">
				      <IMG src="/sang/images/B_bul_subtit.gif" width="16" height="16" align="center" ><B>입고 박스 내역서</B>
            </td>
            <tD width="10%">
			...
			<div class="div-body" id="prt_page">
				...
				<tr>
					...
					<td  width="70%" align="center">
					<label style="font-weight:bold;font-size: 15pt;">입고일자</label>
            <label id ="list_outdt" style="font-size: 13pt;" />
				...
				<div style="top:50px;height:100%;width:100%; overflow:auto;" >
						<table border='1' width="680" align="center"  id="td_boxlist" cellspacing="0">
							<thead>
								...
								<tr>
									<td colspan="3"align="center" ><label class="text1"/>입고매장</td>
                ...
                <tr>
									...
									<td  align="center"colspan="2">
										<label  class="text2">입고
									</td>
									<td align="center" width="100">
										<label class="text2"/>총수량
									</td>
									<td  align="center"colspan="2">
...
<div class="pop-container">
		...
		<div class="div-body" id="reload">
					<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#5985A8">
						<tr bgcolor="#1BA892">
							<td width="80" align="center" height="26">반품일자</td>
