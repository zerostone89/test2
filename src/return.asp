...
<div class="main-body">
	...
	<div class="main-top">
        <table width="100%" height="10%" >
          <tr width="100%" height="100%" cellspacing="0">
              <td width="35%"></td>
              <td width="30%" style=" font-weight: bold;text-align: center;font-size: 14pt;">성남반품등록[<%=dpcd%>]</td>
              <td width="30%" style=" text-align : right;"><input type="button" class="btn_basic1" onclick="select_search();" value="선택조회">&nbsp;
    					<input type="button" class="btn_basic1" onclick="return_open(1);" value="반품등록">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
        ...
        <td bgcolor="#FFFFFF">&nbsp;&nbsp;	&nbsp;&nbsp;
								<select id ='gubun' >
									  <OPTION value="2">매장반품의뢰건</OPTION>
									  <OPTION value="3">본사반품확정건</OPTION>
								</select>&nbsp;&nbsp;
							&nbsp;&nbsp;								<!--
                ...
                <td rowspan="2" align = "center" bgcolor="#FFFFFF">
								<input type="button" class="btn_basic" onclick="return_search(1);" value="검색"style="width:60px; height:40px;vertical-align: middle;">&nbsp;&nbsp;
                <td>
				</td>
			...
			<td width="150" align="center" height="26">확정일자</td>
				<td width="400" bgcolor="#FFFFFF" align="left">
				&nbsp;
					<input type="text" id="confirm-from" size="15">
								<a href="#" onclick="confirm_from_cal1();" class="no-line">
								<IMG src="./images/calendar.png" width="26" height="26" align="absmiddle">
								</a>
								~
								<input type="text" id="confirm-to"  size="15">
	...
	<tr>
        ...
        <td width="30" align="center" height="26">NO</td>
				...
				<td width="120" align="center" >BOX NO.</td>
				<td width="120" align="center" >의뢰 전표번호</td>
		...
		<table width="90%">
          ...
          <td width="10%" align="left">
            ...
            <input type="hidden" class="boxno" value="" id ="modi_CFQTY" style="font-size: 13pt;" >
					...
					<td align="right"  width="25%" ><!-- <input id="btn-spcchk-save" class="btn-save"  align="absmiddle"onclick="returnmodify_save();" >		 -->
			...
			<div style="height: 30%;">
					<table width="100%" height="100%">
						<tr height="10%">
							...
							<td style="width: 10%;"  align="right"><img class="btn-search" align="absmiddle" onclick="select_return_sum();">
							</td>
						</tr>
...
<div class="pop-container">
		...
		<div class="div-footer">
			<a href="#" class="btn-layerClose" onclick="add_close(1)"></a>
		</div>
		</div>
	</div>
</div>
